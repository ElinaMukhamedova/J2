...
DelaunayElements MeanToOsculating_Kozai(DelaunayElements const& mean, double mu, double J2) {
    ...
    double const eccentricAnomaly = Orbit::MeanToEccentric(e, lp);
    double const f = Orbit::EccentricToTrue(e, eccentricAnomaly);

    double const gs = gp - (3 * mu2 * J2 / 4 / Gp4) * (1 - 5 * theta2) * (f - lp);
    ...
    double const ap_rp = (1 + e * cos_f) / eta2;
    double const ap_rp3 = ap_rp * ap_rp * ap_rp;
    double const B20 = -(1 - 3 * theta2) / 4;
    double const B22 = 3 * (1 - theta2) / 4;

    double const delta_L1 = (mu2 * J2 / Lp3) * (B20 * (ap_rp3 - 1 / eta3) + B22 * ap_rp3 * cos_2f_2gs);
    double const delta_L2 = (3 * mu4 * J22 / 128 / Gp7) *
                                        (8 * theta2 * (1 - 5 * theta2)
                                        + e2 * (5 - 18 * theta2 + 5 * theta4)
                                        - 2 * e2 * (1 - theta2) * (1 - 15 * theta2) * cos_2gp)
        + (3 * mu4 * J22 / 512 / Gp6 / Lp) * (ap_rp3) *
    ...
    double const L = Lp + delta_L1 + delta_L2;

    double const delta_G1 = mu2 * J2 / 3 / Gp3 * B22 * (3 * e * cos_f_2gs + 3 * cos_2f_2gs + e * cos_3f_2gs);
    double const delta_G2 = mu4 * J22 / 128 / Gp7 * (1 - theta2) *
          (-12 * e2 * (1 - 15 * theta2) * (f - lp) * sin_2gp - 4 * (7 - 25 * theta2)
               - 8 * e2 * (7 - 17 * theta2) - 96 * e * (1 - 3 * theta2) * cos_f
               - 24 * e2 * (1 - 3 * theta2) * cos_2f + 6 * e * (1 - 3 * theta2) * (1 - eta) * cos_f_m_2gp
               + e2 * (20 * (1 - 3 * theta2) * (1 - eta) / e2 + (239 - 1581 * theta2) / 4 - 6 * eta * (1 - 15 * theta2)) * cos_2gp
               + 6 * e * (4 * (1 - 3 * theta2) * (1 - eta) / e2 + 3 * (3 - 41 * theta2) - 5 * eta * (1 - 3 * theta2)) * cos_f_2gp
               - 36 * (2 * (1 - theta2) + e2 * (1 - 3 * theta2)) * cos_2f_2gp
               - 2 * e * (28 * (1 - 3 * theta2) * (1 - eta) / e2 + 43 - 161 * theta2 + eta * (1 - 3 * theta2)) * cos_3f_2gp
               - 3 * e2 * (12 * (1 - 3 * theta2) * (1 - eta) / e2 + 7 - 33 * theta2) * cos_4f_2gp
               - 6 * e * (1 - 3 * theta2) * (1 - eta) * cos_5f_2gp
               + 3 * (1 - theta2) * (5 * e2 * cos_2f_4gp
                                             + 4 * e * cos_3f_4gp
                                             - (4 - e2) * cos_4f_4gp
                                             - 4 * e * cos_5f_4gp
                                             - e2 * cos_6f_4gp)
          );
    double const G = Gp + delta_G1 + delta_G2;

    double const H = Hp;

    double const delta_l1 = - mu2 * J2 / 24 / Lp / Gp3 *
           (6 * B20 * (3 / e * (4 - e2) * sin_f + 6 * sin_2f + e * sin_3f)
                + B22 * (3 * e * sin_f_m_2gs - 18 * sin_2gs - 3 / e * (4 + 5 * e2) * sin_f_2gs + 1 / e * (28 - e2) * sin_3f_2gs
                          + 18 * sin_4f_2gs + 3 * e * sin_5f_2gs
                         )
           );
    double const delta_l2 = mu4 * J22 * Lp / 4096 / Gp9 *
          (192 * eta4 * (5 - 18 * theta2 + 5 * theta4
                                             - 2 * (1 - theta2) * (1 - 15 * theta2) * cos_2gp) * (f - lp)
          ...
          + 4 * (1 - theta2) * (- 3 * e2 * (1 - 3 * theta2) * (2 - e2) * sin_4f_m_2gp
                                       - 6 * e * (1 - 3 * theta2) * (11 - 5 * e2 + eta3) * sin_3f_m_2gp
                                       - 12 * (2 * (1 - 3 * theta2) * (12 + eta3)
                                               - 6 * e2 * (1 + theta2) - 3 * e4 * (1 - 11 * theta2)) * sin_2f_m_2gp
                                       - 6 / e * ((1 - 3 * theta2) * (96 - 13 * e2 * eta3) + e2 * (25 - 387 * theta2)
                                                 - 39 * e4 * (1 - 11 * theta2)) * sin_f_m_2gp
                                       + 1 / e2 * (96 * (1 - 3 * theta2) * (4 - eta3) + 2 * e2 * (113 - 1347 * theta2)
                                                      + 2 * e4 * (221 - 327 * theta2)
                                                      - e6 * (269 - 2151 * theta2)
                                                      - 16 * e2 * eta3 * (11 + 3 * theta2)
                                                      - 72 * e4 * eta3 * (1 - 15 * theta2)) * sin_2gp
                                       + 12 / e * ((1 - 3 * theta2) * (8 - eta3 * (8 - 24 * e2 + 21 * e4)) / e2
                                                   - 48 * (1 - 4 * theta2) + e2 * (53 - 315 * theta2) + e4 * (41 - 15 * theta2)) * sin_f_2gp
                                       - 48 * ((1 - 3 * theta2) * (16 - eta3 * (16 + 5 * e2)) / e2 + 17 - 123 * theta2
                                               - 4 * e2 * (7 - 39 * theta2) - 5 * e4 * (1 - 3 * theta2)) * sin_2f_2gp
                                       - 4 / e * ((1 - 3 * theta2) * (56 - eta3 * (56 + 152 * e2 + 11 * e4))
                                                  + 16 * (12 - 59 * theta2) + e2 * (51 - 173 * theta2)
                                                  - e4 * (137 - 799 * theta2)) * sin_3f_2gp
                                       - 3 / e2 * (8 * (1 - 3 * theta2) * (17 * e2 + 4 * eta3 * (7 - 3 * e2)) + 2 * e4 * (77 - 279 * theta2)
                                                      - e6 * (29 - 183 * theta2)) * sin_4f_2gp
                                       - 6 / e * (e2 * (37 - 39 * theta2) + 9 * e4 * (5 - 23 * theta2)
                                                  + eta3 * (1 - 3 * theta2) * (128 - 9 * e2)) * sin_5f_2gp
                                       - 4 * (2 * (1 - 3 * theta2) * (10 + 33 * eta3) + 2 * e2 * (7 - 9 * theta2)
                                              + e4 * (11 - 57 * theta2)) * sin_6f_2gp
                                       - 6 * e * (1 - 3 * theta2) * (7 - e2 + 5 * eta3) * sin_7f_2gp
                                       - 3 * e2 * (1 - 3 * theta2) * (2 - e2) * sin_8f_2gp
                                       )
          + (1 - theta2) * (1 - theta2) * (9 * e2 * (2 - e2) * sin_2f_m_4gp
                                                         + 108 * e * (2 - e2) * sin_f_m_4gp
                                                         - 12 * (66 - 34 * e2 + 13 * e4) * sin_4gp
                                                         - 12 / e * (72 + 2 * e2 + 49 * e4) * sin_f_4gp
                                                         - 3 / e2 * (96 + 368 * e2 + 158 * e4 + 161 * e6) * sin_2f_4gp
                                                         - 216 / e * (4 + 5 * e4) * sin_3f_4gp
                                                         + 144 * (17 - 16 * e2 - e4) * sin_4f_4gp
                                                         + 24 / e * (212 - 88 * e2 - 43 * e4) * sin_5f_4gp
                                                         + 1 / e2 * (1568 + 4112 * e2 - 3238 * e4 - 93 * e6) * sin_6f_4gp
                                                         + 12 / e * (168 + 50 * e2 - 95 * e4) * sin_7f_4gp
                                                         + 12 * (82 - 26 * e2 - 11 * e4) * sin_8f_4gp
                                                         + 108 * e * (2 - e2) * sin_9f_4gp + 9 * e2 * (2 - e2) * sin_10f_4gp
                                                         )
          );
    double const l = lp + delta_l1 + delta_l2;
    ...
    double const delta_g1 = mu2 * J2 / 24 / Gp4 *
          (6 * B20 * (3 / e * (4 - e2) * sin_f + 6 * sin_2f + e * sin_3f)
           + B22 * (3 * e * sin_f_m_2gs - 18 * sin_2gs
                    - 3 / e * (4 + 5 * e2) * sin_f_2gs
                    + 1 / e * (28 - e2) * sin_3f_2gs + 18 * sin_4f_2gs + 3 * e * sin_5f_2gs)
           - 18 * (1 - 5 * theta2) * (f - lp + e * sin_f)
           + 3 * (3 - 5 * theta2) * (3 * e * sin_f_2gs + 3 * sin_2f_2gs + e * sin_3f_2gs)
           );
    double const delta_g2 = - mu4 * J22 / 2048 / Gp8 *
          (48 * (2 * (5 + 18 * theta2 - 215 * theta4) + e2 * (25 - 126 * theta2 + 45 * theta4)) * (f - lp)
           - 96 * (2 * (1 - theta2) * (1 - 15  * theta2) + e2 * (5 - 112  * theta2 + 135 * theta4)) * (f - lp) * cos_2gp
           ...
           - 12 * e2 * (1 - theta2) * (1 - 3 * theta2) * sin_4f_m_2gp
           - 12 * e * (1 - theta2) * (1 - 3 * theta2) * (11 + eta) * sin_3f_m_2gp
           - 24 * (1 - theta2) * (2 * (1 - 3 * theta2) * (12 + eta) + e2 * (5 - 39 * theta2)) * sin_2f_m_2gp
           - 12 / e * (96 * (1 - theta2) * (1 - 3 * theta2) + e2 * (57 - 532 * theta2 + 459 * theta4)
                       + e2 * eta * (1 - 3 * theta2) * (3 - 11 * theta2)) * sin_f_m_2gp
           + 2 / e2 * (96 * (1 - theta2) * (1 - 3 * theta2) * (4 - eta)
                          ...
                          - 16 * eta * (e2 * (3 + 10 * theta2 - 33 * theta4)
                                        - 6 * e4 * (1 - 24 * theta2 + 30 * theta4))) * sin_2gp
           + 24 / e * (8 * (1 - theta2) * (1 - 3 * theta2) * (1 - eta) / e2
                       - 8 * (9 - 44 * theta2 + 39 * theta4)
                       - e2 * (139 - 2020 * theta2 + 2337 * theta4)
                       + eta * (1 - 3 * theta2) * (8 * (7 - 9 * theta2) + e2 * (19 - 39 * theta2))) * sin_f_2gp
           - 96 * ((1 - theta2) * (1 - 3 * theta2) * (16 - eta * (16 + 5 * e2)) / e2
                   + (19 - 256 * theta2 + 237 * theta4)
                   - e2 * (1 + 44 * theta2 - 33 * theta4)) * sin_2f_2gp
           - 8 / e * (56 * (1 - theta2) * (1 - 3 * theta2) * (1 - eta) / e2
                      + 8 * (3 - 44 * theta2 + 13 * theta4)
                      - e2 * (69 + 324 * theta2 + 79 * theta4)
                      + eta * (1 - 3 * theta2) * (8 * (9 - 23 * theta2) - e2 * (19 - 23 * theta2))) * sin_3f_2gp
           + 12 / e2 * (12 * e2 * (7 - 32 * theta2 + 33 * theta4)
                           + e4 * (21 - 76 * theta2 + 159 * theta4)
                           - 16 * eta * (1 - 3 * theta2) * (7 * (1 - theta2) + 3 * e2 * (1 - 2 * theta2))) * sin_4f_2gp
           + 12 / e * (e2 * (43 - 252 * theta2 + 225 * theta4)
                       - eta * (1 - 3 * theta2) * (128 * (1 - theta2) + e2 * (7 - 15 * theta2))) * sin_5f_2gp
           - 8 * (1 - theta2) * (2 * (1 - 3 * theta2) * (10 + 33 * eta) - 3 * e2 * (3 - 17 * theta2)) * sin_6f_2gp
           - 12 * e * (1 - theta2) * (1 - 3 * theta2) * (7 + 5 * eta) * sin_7f_2gp
           - 12 * e2 * (1 - theta2) * (1 - 3 * theta2) * sin_8f_2gp
           + 9 * e2 * (1 - theta2) * (1 - theta2) * sin_2f_m_4gp
           + 108 * e * (1 - theta2) * (1 - theta2) * sin_f_m_4gp
           - 6 * (1 - theta2) * (1 - theta2) * (66 - e2) * sin_4gp
           - 12 / e * (1 - theta2) * (1 - theta2) * (36 + 19 * e2) * sin_f_4gp
           - 3 / e2 * (16 * (1 - theta2) * (1 - theta2) * (3 + 13 * e2) + e4 * (7 + 194 * theta2 - 9 * theta4)) * sin_2f_4gp
           - 24 / e * (18 * (1 - theta2) * (1 - theta2) - e2 * (19 - 102 * theta2 + 35 * theta4)) * sin_3f_4gp
           + 12 * (2 * (83 - 210 * theta2 + 103 * theta4) + e2 * (11 - 66 * theta2 + 23 * theta4)) * sin_4f_4gp
           + 24 / e * (106 * (1 - theta2) * (1 - theta2) + e2 * (53 - 138 * theta2 + 69 * theta4)) * sin_5f_4gp
           + 1 / e2 * (16 * (1 - theta2) * (1 - theta2) * (49 + 153 * e2)
                          + e4 * (197 - 538 * theta2 + 277 * theta4)) * sin_6f_4gp
           + 12 / e * (1 - theta2) * (1 - theta2) * (84 + 67 * e2) * sin_7f_4gp
           + 6 * (1 - theta2) * (1 - theta2) * (82 + 15 * e2) * sin_8f_4gp
           + 108 * e * (1 - theta2) * (1 - theta2) * sin_9f_4gp
           + 9 * e2 * (1 - theta2) * (1 - theta2) * sin_10f_4gp
          );
    double const g = gp + delta_g1 + delta_g2;

    double const delta_h1 = (mu2 * J2 / 4 / Gp4) * theta *
                (-6 * (f - lp + e * sin_f) + 3 * e * sin_f_2gs
    ...
    double const delta_h2 = mu4 * J22 / 128 / Gp8 * theta *
        (12 * (4 * (1 - 10 * theta2) - e2 * (9 - 5 * theta2) + 2 * e2 * (8 - 15 * theta2) * cos_2gp) * (f - lp)
         ...
         - 6 * e * (1 - 3 * theta2) * (1 - eta) * sin_f_m_2gp
         - e2 * (4 * (7 + 3 * theta2) * (1 - eta) / e2 - 191 + 1053 * theta2 / 2 + 12 * eta * (8 - 15 * theta2)) * sin_2gp
         + 6 * e * ((1 - 3 * theta2) * (4 - eta * (4 + 5 * e2)) / e2 + 3 * (35 - 73 * theta2)) * sin_f_2gp
         + 24 * (6 * (1 - theta2) + e2 * (4 - theta2)) * sin_2f_2gp
         - 2 * e * ((1 - 3 * theta2) * (28 - eta * (28 - e2)) / e2 - (21 + 97 * theta2)) * sin_3f_2gp
         - 6 * e2 * (6 * (1 - 3 * theta2) * (1 - eta) / e2 - 13 * e2 * theta2) * sin_4f_2gp
         - 6 * e * (1 - 3 * theta2) * (1 - eta) * sin_5f_2gp
         - 3 * e2 * (7 + 5 * theta2) * sin_2f_4gp
         - 12 * e * (5 + theta2) * sin_3f_4gp
         - 3 * (4 * (4 - theta2) + e2 * (7 + theta2)) * sin_4f_4gp
         - 12 * e * (3 - theta2) * sin_5f_4gp
         - e2 * (7 - 3 * theta2) * sin_6f_4gp
        );
    double const h = hp + delta_h1 + delta_h2;

    return DelaunayElements{l, g, h, L, G, H};
}

DelaunayElements OsculatingToMean_Kozai(DelaunayElements const& osculating, double mu, double J2) {
    DelaunayElements const el1 = MeanToOsculating_Kozai(osculating, mu, J2);
    DelaunayElements const el2 = MeanToOsculating_Kozai(el1, mu, J2);
    DelaunayElements const el3 = MeanToOsculating_Kozai(el2, mu, J2);
    return el3;
}